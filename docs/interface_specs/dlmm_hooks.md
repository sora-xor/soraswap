...
- `schedule_twamm_v2(...)` is the canonical TWAMM scheduling entrypoint. It escrows the full input amount into the hook-manager contract subject before trigger execution can route slices.
